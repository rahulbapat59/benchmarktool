...
def generate_report(workload_title, log_fn, benchlog_fn, report_fn):
    ...
    with open(report_fn, 'w') as f:
        ...
        f.write("<pre id=\"csv_cpu_heatmap\" style=\"display: none\">")
        for x in cpu_heatmap:
            # ex1470699705000, 0, 100.0, pass2 - 23, cpu44
            f.write(x)
            f.write("\n")
        f.write("</pre>\n")
        f.write("<pre id=\"csv_cpu_overall\" style=\"display: none\">")
        for x in cpu_overall:
            f.write(x)
            f.write("\n")
        f.write("</pre>\n")
        f.write("<pre id=\"csv_diskio_overall\" style=\"display: none\">")
        for x in diskio_overall:
            f.write(x)
            f.write("\n")
        f.write("</pre>")
        f.write("<pre id=\"csv_diskio_heatmap\" style=\"display: none\">")
        for x in diskio_heatmap:
            f.write(x)
            f.write("\n")
        f.write("</pre>")
        f.write("<pre id=\"csv_memory_overall\" style=\"display: none\">")
        for x in memory_overall:
            f.write(x)
            f.write("\n")
        f.write("</pre>")
        f.write("<pre id=\"csv_memory_heatmap\" style=\"display: none\">")
        for x in memory_heatmap:
            f.write(x)
            f.write("\n")
        f.write("</pre>")
        f.write("<pre id=\"csv_procload_overall\" style=\"display: none\">")
        for x in procload_overall:
            f.write(x)
            f.write("\n")
        f.write("</pre>")
        f.write("<pre id=\"csv_procload_heatmap\" style=\"display: none\">")
        for x in procload_heatmap:
            f.write(x)
            f.write("\n")
        f.write("</pre>")
        f.write("<pre id=\"csv_network_heatmap\" style=\"display: none\">")
        for x in network_heatmap:
            f.write(x)
            f.write("\n")
        f.write("</pre>")
        f.write("<pre id=\"csv_network_overall\" style=\"display: none\">")
        for x in  network_overall:
            f.write(x)
            f.write("\n")
        f.write("</pre>")
        f.write("</body>\n")
