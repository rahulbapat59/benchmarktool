...
class APC:
    ...
    def connect(self):
        ...
        try:
            tn = telnetlib.Telnet(APC_DEFAULT_HOST)
            tn.set_debuglevel(1)
            tn.read_until(b'\xff\xfb\x01')
...
def main():
    ...
    try:
        ...
        raise 'ERROR: Timeout connecting to APC'
    ...
    if args.debug:
        ...
        try:
            ...
            raise 'APC failed!  Pexpect result:\n%s' % e
        finally:
            apc.disconnect()
