...
string1 = "rm -f /opt/logs/memcached/" + "summary_download.csv"
os.system(string1)
path = "/opt/logs/memcached/sys.argv[1]"
for root, dirs, files in os.walk(path):
    for name in files:
        ...
        if name == "index.txt":
            ...
            #    if i == 1:
            write_file_path = path + sys.argv[1] + "/summary_download.csv"
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            f1.writelines(mystring.split("-K", 1)[1].split()[0])
                            f1.writelines(",")
